...
import { faBriefcase,faArrowRight, faGear, faGears, faMoneyBill, faMoneyBill1Wave, faPhoneVolume, faZ, faPiggyBank, faMagnifyingGlassDollar } from '@fortawesome/free-solid-svg-icons';
        ...
        <VerticalTimeline>
          ...
          >
            ...
            <div id="product-summary">
              ...
              <a href={RESEARCH_ENGINE_URL} target='_blank' rel='noreferrer'><FontAwesomeIcon icon={faArrowRight} /> Community by Fuel Cycle: Android</a>
              <a href={RESEARCH_ENGINE_URL} target='_blank' rel='noreferrer'><FontAwesomeIcon icon={faArrowRight} /> Community by Fuel Cycle: IOS</a>
            </div>
          </VerticalTimelineElement>
          <VerticalTimelineElement
            className="vertical-timeline-element--work"
